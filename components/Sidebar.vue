  ...
  >
    ...
    >
      <img
        ...
        alt="profile-picture"
      />
      <p class="text-xl text-[#005782] font-semibold">John Doe</p>
    </div>
    <ul class="pt-[2rem] flex flex-col h-[50%] w-[100%]">
      <nuxt-link class="py-1 flex justify-center w-[100%]" to="/profile">
        <div
          class="text-[#005782] flex justify-start pl-[6.25rem] gap-[0.2rem] py-[0.3rem] border border-slate-300 w-[100%] text-center rounded-md cursor-pointer hover:text-[#0097d3]"
        >
