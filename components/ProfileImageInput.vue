...
<template>
  <div class="p-6 max-w-lg mx-auto bg-white rounded-xl shadow-md space-y-4">
    <form @submit.prevent="submitForm" class="space-y-4">
      ...
      <button
        class="w-full px-4 py-2 text-white bg-[var(--secondary-color)] rounded-lg hover:bg-[#786de1] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
        type="submit"
      >
        Save
      </button>
